...
- Focus on the code, the design, and the user impact.
- Assume good intent, but be direct about risks, regressions, and gaps.
- Welcome new contributors and help them understand project expectations.
...
This code of conduct applies to repository discussions, pull requests, issues, release discussions, and other project communication channels.
